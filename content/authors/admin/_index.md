...
social:
  - icon: google-scholar # graduation-cap # Alternatively, use `google-scholar` icon from `ai` icon pack
    icon_pack: ai #fas
    link: https://scholar.google.com/citations?user=9Aagu58AAAAJ&hl=en
...
If you are interested in collaboration or wish to engage in discussions with me, feel free to contact me at: minhaksong {at} kaist {dot} ac {dot} kr.
